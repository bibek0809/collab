...
export default function useWebSocket(
  ...
  useEffect(() => {
    ...
    versionVectorRef.current = versionVector;
    ...
    client.onConnect = () => {
      ...
      try {
        ...
        client.subscribe(
          `/topic/document/${documentId}/ack/${userId}`,
          (msg) => {
            try {
              const data = JSON.parse(msg.body);
        ...
        client.publish({
          ...
          body: JSON.stringify({
            ...
            userId,
            userName,
            versionVector: versionVectorRef // ✅ FIX
          }),
        });
    ...
    client.onWebSocketClose = () => {
      ...
      if (reconnectAttempts.current < maxReconnectAttempts) {
        ...
        console.log(
          `[WebSocket] Will attempt reconnection (${reconnectAttempts.current}/${maxReconnectAttempts})`,
        );
      }
    };
  ...
  const sendCursor = useCallback(
    (cursorPosition, selectionStart = null, selectionEnd = null) => {
      ...
      console.log("[WebSocket] Sending cursor:", {
        cursorPosition,
        selectionStart,
        selectionEnd,
      });
